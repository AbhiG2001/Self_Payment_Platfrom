    ...
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <main className="mt-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {raw.UtilityAndGovernment.map((UtilityAndGovernment, index) => (
            <div
              key={index}
              onClick={() => navigate(UtilityAndGovernment.path)}
              className="bg-white p-4 rounded shadow text-center hover:shadow-lg cursor-pointer transition"
            >
              <img
                src={UtilityAndGovernment.icon}
...
export default UtilityAndGovernment;
